...
final class LocalDateCodecsTests
    ...
    void testLocalDateAsDateTimeCodec() {
        LocalDateAsDateTimeCodec localDateAsDateTimeCodec =
                new LocalDateAsDateTimeCodec();
        assertThrows(
                BsonInvalidOperationException.class,
                () -> testCodec(localDateAsDateTimeCodec, LocalDate.MIN)
        );
        assertThrows(
                BsonInvalidOperationException.class,
                () -> testCodec(localDateAsDateTimeCodec, LocalDate.MAX)
        );
        testCodec(localDateAsDateTimeCodec, LocalDate.now());
    }
}
